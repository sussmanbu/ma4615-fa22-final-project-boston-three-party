---
title: Blog Post 1 - Introduction to Boston Three Party! 
author: Tessa,Maryam,Veer and Priya 
date: '2022-10-18'
slug: []
categories: []
tags: []
description: Here we first search for datasets.
toc: yes
authors: []
series: []
lastmod: '2022-10-18T08:45:11-04:00'
featuredVideo: ~
featuredImage: ~
---
...
This dataset comes from the New York City Government and contains around 25 columns and 100 rows. The columns are divided into the different boroughs of New York City. Each column gives the estimate of different characteristics of the population. The rows describe these numbers by race, age, and gender. This data is from 5 years from 2012-2016. The data tended to estimate the urban and rural populations. The most important rows would in our case is the total housing units and the estimate of the different racial makeup of the population. This data directly comes from the U.S Census Bureau. It is in an excel spreadsheet and can be easily cleaned if needed. A challenge we might deal with is how to show how the population of different races and age groups in different boroughs based on race.
...
In the Kaggle dataset, there is no breakdown of the population between the different boroughs, it has the New York City population as a whole. 

One challenge we foresee is combining the different individual variables of which we are interested in into one final dataset which we want to analyze. One problem with combining datasets is that they may have different frequencies of how often data is recorded, or that they may be recorded over different dates. 
