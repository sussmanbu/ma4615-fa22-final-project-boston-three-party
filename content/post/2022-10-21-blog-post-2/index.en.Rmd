...
---
After reading through your comments on our last blog post we decided to change topic, and find new data. We are now using world bank data that would allows to perform time series analysis. We have included the dataset. We want to hear your feedback about our new topic and dataset before go ahead and find summary statistics and make plots. However, we went ahead and performed exploratory data analysis. 
