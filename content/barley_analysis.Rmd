...
```{r}
barley_co2_data %>% ggplot(aes(y = (GDP_growth), x = `Price per bushel 1/`)) + geom_point()
barley_co2_data %>% ggplot(aes(y = (Goods_services_exports), x = `Price per bushel 1/`)) + geom_point()
barley_co2_data %>% ggplot(aes(y = (Goods_services_exports), x = (Production))) + geom_point()
barley_co2_data %>% ggplot(aes(y = (Forest_area_percent), x = `Area harvested`)) + geom_point()
